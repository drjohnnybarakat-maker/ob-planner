[index.html](https://github.com/user-attachments/files/27624994/index.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
/* ═══════════════════════════════════════
   SCREEN 1 — FORM
═══════════════════════════════════════ */
.form-scroll { padding: 20px 16px; padding-bottom: 110px; }
...
<div id="app">
  ...
  <div class="screen active" id="screenForm">
    ...
    <!-- FLOATING GENERATE BUTTON — fixed position, always visible -->
  </div>

  <!-- Fixed floating button outside all screen containers -->
